...
/// Descriptive reference records imported from free-exercise-db (public domain), plus the
/// cited research findings (`evidence`) that `scripts/annotate_catalog.py` adds. Browsing them
/// never enrols an exercise into guidance. The bundled file's shape and unique ids are checked
/// by `core/python/tests/test_contract.py` and `test_catalog_evidence.py`, not at runtime.
